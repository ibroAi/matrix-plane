...
MVP scaffold voor een CLI die AI-governance modules installeert vanuit `construct`. De volledige behavioral spec staat in `docs/CLI_CONTRACT.md` — lees die **voor** je iets implementeert.
...
| `docs/MENTAL_MODEL.md` | Scope en grenzen van ibro-cli vs construct |
...
- Modules worden gedownload van GitHub (`ibroAi/construct`), niet van npm
...
- Geen `ai/` governance folder aanmaken in dit package — die zit in construct modules
